namespace CountryFighter
{
    public class Country
    {
        ...
        public void AsignArmy(Army army) => MainArmy = army;
    }

    public class Army : IMyObserver<UnitType, int>
    {
        public double AverageQuality { get => ArmyUnits.FindByType(UnitType.Soldier).Quality; }
        ...
        public void TakeDamage(ArmyUnit unit, int damage, int troopsDamage)
        {
            ...
            float emotionalDamage = damage / unit.Count;
